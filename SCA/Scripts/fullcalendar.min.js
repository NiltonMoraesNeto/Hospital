...
function (a) {
    ...
    }), Va = "_d" in b() && "updateOffset" in b, Wa = Va ?
    function (a, c) {
    ...
    var wb = Pa.BasicView = ob.extend({
        ...
        renderSkeletonHtml: function () {
            return '<table><thead class="fc-head" style="background: #F5F5F5"><tr><td class="fc-head-container ' + this.widgetHeaderClass + '"></td></tr></thead><tbody class="fc-body"><tr><td class="' + this.widgetContentClass + '"><div class="fc-day-grid-container"><div class="fc-day-grid"/></div></td></tr></tbody></table>'
        },
