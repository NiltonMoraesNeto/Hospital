        ...
        show: function () {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                switch (inside ? placement.split(' ')[1] : placement) {
                    case 'bottom':
                        tp = { top: pos.top + pos.height, left: pos.left + pos.width / 2 - actualWidth / 2 + 28 }
                        break;
                    case 'top':
                        tp = { top: pos.top - actualHeight, left: pos.left + pos.width / 2 - actualWidth / 2 + 28 }
                        break;
                    case 'left':
